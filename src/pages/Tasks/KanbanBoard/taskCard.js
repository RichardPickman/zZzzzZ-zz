...
const CardTaskBox = props => {
    ...
    const { data, updateBoards } = props;

    // Здесь я добавил обработчик onDelete чтобы удалять таски, а потом вызвать функцию, чтобы обновить борды
                                    ...
                                    {data.progressBar && (
                                        <div className="mb-3">
                                            ...
                                            <div className="progress rounded-3 progress-sm">
                                                <div
                                                    className={
                                                        'progress-bar bg-' + data.progressBarColor
                                                    }
                                                    role="progressbar"
